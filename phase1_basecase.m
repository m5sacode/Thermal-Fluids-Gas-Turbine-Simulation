...
function [nT1, nT2] = phase1_basecase()
    %% Set Up
    ...
    T48s = TcalcS(sb48s, yN2, yO2, T48-200);
    ...
    sb5rs = sb48r;
    T5s = TcalcS(sb5s, yN2, yO2, T5-200);
